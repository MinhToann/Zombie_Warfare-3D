...
public class SimplePool : MonoBehaviour
{
    ...
    {
        if (prefab != null && !poolInstance.ContainsKey(prefab.PoolTypeObject))
        {
            poolInstance.Add(prefab.PoolTypeObject, new Pool(prefab, amount, parent));
        }
    }
    ...
    {
        poolInstance[gameUnit.PoolTypeObject].Despawn(gameUnit);
